...
void TForm6::refresh()
{
    ...
    ui->d36_1->setText(QString::number((static_cast<float>(timingDataBuf[36]) - 25000) / 10, 'f', 1));
    ui->d37_1->setText(QString::number((static_cast<float>(timingDataBuf[37]) - 25000) / 10, 'f', 1));
