...
void TForm6::refresh()
{
    ...
    ui->d36->setText(QString::number(static_cast<float>(static_cast<qint16>(timingDataBuf[36]) - 25000) / 100, 'f', 2));
    ui->d37->setText(QString::number(static_cast<float>(static_cast<qint16>(timingDataBuf[37]) - 25000) / 100, 'f', 2));
